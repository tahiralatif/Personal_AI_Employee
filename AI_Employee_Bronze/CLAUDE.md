...
- Python 3.12+ + watchdog + python-dotenv (1-bronze-vault-setup)
- uv package manager (1-bronze-vault-setup)
...
cd src && python -m pytest && python -m ruff check .

## Language Conventions

Python 3.12+: Follow standard Python conventions with type hints, docstrings, and exception handling

## Recent Changes

- 1-bronze-vault-setup: Added Python 3.12 + watchdog + python-dotenv
- 1-bronze-vault-setup: Added uv package manager
